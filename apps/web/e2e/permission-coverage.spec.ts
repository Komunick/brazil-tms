...
const CASES: Case[] = [
  ...
  },
  {
    ...
    name: "confirm import",
    method: "POST",
    path: `/api/imports/${FAKE}/confirm`,
    holder: "opsManager",
    nonHolder: "finance",
  },
  {
    key: "import_trips",
    name: "create trip (manual)",
    method: "POST",
    path: "/api/trips",
    holder: "opsManager",
    nonHolder: "finance",
  },
  {
    ...
    name: "edit trip plan",
    method: "PATCH",
    path: `/api/trips/${FAKE}/plan`,
    holder: "opsManager",
    nonHolder: "finance",
  },
  {
    key: "manage_trips",
    name: "edit operational fields",
    method: "PATCH",
    path: `/api/trips/${FAKE}/operational-fields`,
    holder: "opsManager",
    nonHolder: "finance",
  },
  {
    ...
    method: "POST",
    path: `/api/trips/${FAKE}/assignment`,
    holder: "dispatcher",
    nonHolder: "finance",
  },
  {
    ...
    method: "POST",
    path: `/api/trips/${FAKE}/assignment/confirm`,
    holder: "dispatcher",
    nonHolder: "finance",
  },
  {
    key: "update_trip_status",
    name: "status transition",
    method: "POST",
    path: `/api/trips/${FAKE}/status`,
    holder: "dispatcher",
    nonHolder: "finance",
  },
  ...
  // cancel; finance must not even read the option lists.
  {
    ...
    name: "cancel trip",
    method: "POST",
    path: `/api/trips/${FAKE}/cancel`,
    holder: "dispatcher",
    nonHolder: "fleetCoord",
  },
  {
    key: "cancel_trip",
    name: "list cancellation options",
    method: "GET",
    path: "/api/cancellation-options",
    holder: "opsManager",
    nonHolder: "finance",
  },
  {
    ...
    name: "add trip event",
    method: "POST",
    path: `/api/trips/${FAKE}/events`,
    holder: "dispatcher",
    nonHolder: "finance",
  },
  {
    key: "create_exceptions",
    name: "create exception",
    method: "POST",
    path: `/api/trips/${FAKE}/exceptions`,
    holder: "dispatcher",
    nonHolder: "finance",
  },
  {
    key: "resolve_exceptions",
    name: "edit exception",
    method: "PATCH",
    path: `/api/exceptions/${FAKE}`,
    holder: "dispatcher",
    nonHolder: "finance",
  },
  {
    ...
    method: "POST",
    path: `/api/exceptions/${FAKE}/transition`,
    holder: "dispatcher",
    nonHolder: "finance",
  },
  {
    ...
    method: "PATCH",
    path: `/api/documents/${FAKE}`,
    holder: "finance",
    nonHolder: "dispatcher",
  },
  {
    key: "mark_completed",
    name: "mark completed",
    method: "POST",
    path: `/api/trips/${FAKE}/complete`,
    holder: "opsManager",
    nonHolder: "finance",
  },
  {
    key: "mark_billing_ready",
    name: "mark billing ready",
    method: "POST",
    path: `/api/trips/${FAKE}/billing-ready`,
    holder: "finance",
    nonHolder: "dispatcher",
  },
  {
  ...
  {
    key: "edit_rates",
    name: "edit billing item",
    method: "PATCH",
    path: `/api/trips/${FAKE}/billing`,
    holder: "finance",
    nonHolder: "dispatcher",
  },
  {
    ...
    method: "POST",
    path: `/api/trips/${FAKE}/billing/adjustments`,
    holder: "finance",
    nonHolder: "dispatcher",
  },
  {
    key: "edit_rates",
    name: "remove billing adjustment",
    method: "DELETE",
    path: `/api/billing-adjustments/${FAKE}`,
    holder: "finance",
    nonHolder: "dispatcher",
  },
  {
    key: "export_billing",
    name: "create export batch",
    method: "POST",
    path: "/api/billing/exports",
    holder: "finance",
    nonHolder: "dispatcher",
  },
  {
    ...
    method: "GET",
    path: `/api/billing/exports/${FAKE}/download`,
    holder: "finance",
    nonHolder: "dispatcher",
  },
  {
    key: "manage_commercial_data",
  ...
  },
  {
    ...
    method: "POST",
    path: "/api/customer-sla-rules",
    holder: "opsManager",
    nonHolder: "dispatcher",
  },
  {
    key: "manage_fleet_data",
    name: "create driver",
    method: "POST",
    path: "/api/master-data/drivers",
    holder: "fleetCoord",
    nonHolder: "dispatcher",
  },
  {
  ...
  },
  {
    ...
    method: "DELETE",
    path: `/api/master-data/customers/${FAKE}`,
    holder: "admin",
    nonHolder: "dispatcher",
  },
  {
